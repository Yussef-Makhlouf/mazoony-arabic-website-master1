  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const cityData = {
        ...
        count: 0 // عدد المأذونين يبدأ بصفر
      }
      ...
      if (response.ok) {
        ...
        throw new Error(errorData.error || "فشل في إضافة المدينة")
      }
    } catch (error: any) {
      console.error("خطأ في إضافة المدينة:", error)
      toast({
        title: "خطأ",
        description: error.message || "حدث خطأ في إضافة المدينة",
        variant: "destructive",
      })
    } finally {
      setIsLoading(false)
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">إضافة مدينة جديدة</h1>
          <p className="text-gray-600">إضافة مدينة جديدة إلى النظام</p>
        </div>
